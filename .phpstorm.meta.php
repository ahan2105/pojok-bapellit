...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\laragon\www\pojok-bapelit\public\storage' => 'string',
            ...
            'webpush.vapid.subject' => 'string',
            'webpush.vapid.public_key' => 'string',
            'webpush.vapid.private_key' => 'string',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.C:\\laragon\\www\\pojok-bapelit\\public\\storage','logging.default','logging.deprecations.channel',
...
'session.http_only','session.same_site','session.partitioned','session.serialization','webpush.vapid.subject',
'webpush.vapid.public_key','webpush.vapid.private_key','webpush.vapid.pem_file','webpush.model','webpush.table_name',
'webpush.database_connection','webpush.client_options','webpush.automatic_padding','excel.exports.chunk_size','excel.exports.pre_calculate_formulas',
...
'excel.exports.properties.category','excel.exports.properties.manager','excel.exports.properties.company','excel.exports.source_handlers','excel.imports.read_only',
...
'signed','throttle','verified','cek.status','admin',);
        registerArgumentsSet('routes', 'akun.nonaktif','login',
'logout','absensi.scan-page','absensi.scan','absensi.scan-process','booking.index',
'booking.show','booking.store','booking.check-availability','booking.detail','booking.cancel',
'riwayat.index','riwayat.show','riwayat.cancel','surat.index','surat.store',
'surat.show','surat.download','presensi.index','notifications.index','notifications.read',
'notifications.readAll','admin.notifications.stream','admin.aula.index','admin.aula.create','admin.aula.store',
'admin.aula.show','admin.aula.edit','admin.aula.update','admin.aula.destroy','admin.aula.toggle-status',
'admin.aula.show','admin.aula.delete-photos','admin.aula.delete-photo','admin.kelolabooking.index','admin.kelolabooking.detail',
'admin.kelolabooking.approve','admin.kelolabooking.reject','admin.kelolabooking.complete','admin.kelolabooking.update','admin.kelolabooking.destroy',
'admin.kelolasurat.index','admin.kelolasurat.pengaturan','admin.kelolasurat.pengaturan.update','admin.kelolasurat.download-file','admin.kelolasurat.edit',
'admin.kelolasurat.update','admin.kelolasurat.destroy','admin.kelolaakun.index','admin.kelolaakun.create','admin.kelolaakun.store',
'admin.kelolaakun.edit','admin.kelolaakun.update','admin.kelolaakun.destroy','admin.pegawai.index','admin.absensi.index',
'admin.absensi.create','admin.absensi.store','admin.absensi.export-rekap','admin.absensi.qr','admin.absensi.qr-regenerate',
'admin.absensi.export','admin.absensi.show','admin.absensi.update-kehadiran','admin.absensi.lock','admin.absensi.destroy','storage.local','storage.local.upload',);
        registerArgumentsSet('views', 
'admin.absensi.create','admin.absensi.index','admin.absensi.partials.qr-modal','admin.absensi.pegawai','admin.absensi.show',
'admin.aula.create','admin.aula.edit','admin.aula.index','admin.kelolaakun.create','admin.kelolaakun.index',
'admin.kelolabooking.index','admin.kelolasurat.create','admin.kelolasurat.index','admin.kelolasurat.pengaturan','auth.akun-nonaktif',
'auth.confirm-password','auth.forgot-password','auth.login','auth.register','auth.reset-password',
'auth.verify-email','booking.index','booking.show','components.application-logo','components.auth-session-status',
'components.danger-button','components.dropdown','components.dropdown-link','components.input-error','components.input-label',
'components.modal','components.nav-link','components.notification-bell','components.primary-button','components.push-setup',
'components.responsive-nav-link','components.secondary-button','components.sweetalert','components.text-input','layouts.admin',
'layouts.app','layouts.user','navbar.index','presensi.index','presensi.scan',
'presensi.scan-result','profile.edit','profile.partials.delete-user-form','profile.partials.update-password-form','profile.partials.update-profile-information-form',
'riwayat.index','surat.index','laravel-exceptions-renderer::components.badge','laravel-exceptions-renderer::components.empty-state','laravel-exceptions-renderer::components.file-with-line',
...
'C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.failed','C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.password','C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.throttle','C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.previous','C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.next',
'C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.reset','C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.sent','C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.throttled','C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.token','C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.user',
'C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted','C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted_if','C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.active_url','C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after','C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after_or_equal',
'C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha','C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_dash','C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_num','C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.any_of','C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.array',
'C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.array_keys','C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ascii','C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.base64','C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before','C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before_or_equal',
'C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.array','C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.file','C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.numeric','C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.string','C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.boolean',
'C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.can','C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.confirmed','C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.contains','C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.current_password','C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date',
'C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_equals','C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_format','C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.decimal','C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined','C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined_if',
'C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.different','C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits','C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits_between','C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.dimensions','C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.distinct',
'C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_contain','C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_end_with','C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_start_with','C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.email','C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.encoding',
'C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ends_with','C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.enum','C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.exists','C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.extensions','C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.file',
'C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.filled','C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.array','C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.file','C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.numeric','C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.string',
'C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.array','C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.file','C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.numeric','C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.string','C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.hex_color',
'C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.image','C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in','C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array','C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array_keys','C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.integer',
'C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ip','C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv4','C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv6','C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.json','C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.list',
'C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lowercase','C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.array','C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.file','C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.numeric','C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.string',
'C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.array','C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.file','C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.numeric','C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.string','C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mac_address',
'C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.array','C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.file','C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.numeric','C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.string','C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max_digits',
'C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimes','C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimetypes','C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.array','C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.file','C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.numeric',
'C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.string','C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min_digits','C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing','C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_if','C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_unless',
'C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with','C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with_all','C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.multiple_of','C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_in','C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_regex',
'C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.numeric','C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.letters','C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.mixed','C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.numbers','C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.symbols',
'C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.uncompromised','C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present','C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_if','C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_unless','C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with',
'C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with_all','C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited','C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if','C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_accepted','C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_declined',
'C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_unless','C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibits','C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.regex','C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required','C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_array_keys',
'C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if','C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_accepted','C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_declined','C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_unless','C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with',
'C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with_all','C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without','C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without_all','C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.same','C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.array',
'C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.file','C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.numeric','C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.string','C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.starts_with','C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.string',
'C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.timezone','C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.unique','C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uploaded','C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uppercase','C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.url',
'C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ulid','C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uuid','C:.laragon.www.pojok-bapelit.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.custom.attribute-name.rule-name',);
        registerArgumentsSet('env', 
'APP_NAME','APP_ENV','APP_KEY','APP_DEBUG','APP_URL',
'ASET_URL','APP_LOCALE','APP_FALLBACK_LOCALE','APP_FAKER_LOCALE','APP_MAINTENANCE_DRIVER',
...
'AWS_DEFAULT_REGION','AWS_BUCKET','AWS_USE_PATH_STYLE_ENDPOINT','VITE_APP_NAME','VAPID_PUBLIC_KEY',
